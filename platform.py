...
class Nordicnrf54Platform(PlatformBase):
    ...
    def configure_default_packages(self, variables, targets):
        ...
        if set(["bootloader", "erase", "softdevice"]) & set(targets):
        ...
        bootloader_pkg = "framework-arduinoadafruitnrf54-bootloader"
        if bootloader_pkg in self.packages and (
            "arduino" in frameworks
            or "bootloader" in targets
        ):
